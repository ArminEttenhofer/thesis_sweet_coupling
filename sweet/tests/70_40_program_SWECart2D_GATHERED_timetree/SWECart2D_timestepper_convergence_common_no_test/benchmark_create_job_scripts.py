...
if group == "l1":
    ...
    ts_methods = [
                         ...
                         "SS(EXP(l),ERK(n,order=1),order=1)",
                         "ETDRK(EXP(l),n,order=1)",
                         "SLETDRK(EXP(l),na(sl_order=2),nr,order=1)",
    		####'ln_erk',
    		####'l_erk_n_erk',
    ...
    ts_methods = [
                         ...
                         "SS(IRK(l,order=2),ERK(n,order=2),order=2)",
                         "ERK(ln,order=2)",
                         "SS(EXP(l),ERK(n,order=2),order=2)",
                         "ETDRK(EXP(l),n,order=2)",
                         ####"SLETDRK(EXP(l),na(sl_order=2),nr,order=2)",
    		####'ln_erk',
