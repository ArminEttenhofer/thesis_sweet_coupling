...
tagnames_y = [
    'cart2d_data_diff_prog_h_pert.res_norm_linf',
    'cart2d_data_diff_prog_u.res_norm_linf',
    'cart2d_data_diff_prog_v.res_norm_linf',
]
...
#    			data_filter = data_filter
    	...
    	for group_name, group_data in d.get_data_float().items():
    		...
    		if 'vrt' in tagname_y or 'SLETDRK' in group_name:
    		...
    		for i in range(conv_test_range_start, conv_test_range_end):
    			...
    			if error_convergence != '-':
    				...
    				if  group_name.lower() in ["l_rexi", 'exp(l)']:
