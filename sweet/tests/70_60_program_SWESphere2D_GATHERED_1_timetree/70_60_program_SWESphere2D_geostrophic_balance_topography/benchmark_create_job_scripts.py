...
jg.runtime.benchmark_name = 'geostrophic_balance_topography'
...
ts_methods = [
    ...
    [f"SS(IRK(lg,{o}),ERK(ADDT(lc,lb,n),{o}),{o})",        2,    2,    0],
    #['lg_irk_lc_n_erk_ver0',        2,    2,    0],
    [f"SS(ERK(ADDT(lc,lb,n),{o}),IRK(lg,{o}),{o})",        2,    2,    0],
    #['lg_irk_lc_n_erk_ver1',        2,    2,    0],

    ##############[f"SS(REXI(l),ERK(n,{o}),{o})",        2,    2,    0],
    #['l_exp_n_erk_ver0',    2,    2,    0],
    ##############[f"SS(ERK(n,{o}),REXI(l),{o})",        2,    2,    0],
    #['l_exp_n_erk_ver1',    2,    2,    0],

    [f"SS(REXI(lg),ERK(ADDT(lc,lb,n),{o}),{o})",        2,    2,    0],
    #['lg_exp_lc_n_erk_ver0',    2,    2,    0],
    [f"SS(ERK(ADDT(lc,lb,n),{o}),REXI(lg),{o})",        2,    2,    0],
    #['lg_exp_lc_n_erk_ver1',    2,    2,    0],

    # Extra tests for timeTree
    [f"SS(EXP(lg),ERK(ADDT(lc,lb,n),{o}),{o})",        2,    2,    0],
    [f"SS(ERK(ADDT(lc,lb,n),{o}),EXP(lg),{o})",        2,    2,    0],

    #################[f"ETDRK(REXI(l),n,{o})",        2,    2,    0],
    #['l_exp_n_etdrk',    2,    2,    0],
    [f"ETDRK(lg,ADDT(lc,lb,n),{o})",        2,    2,    0],
    #['lg_exp_lc_n_etdrk',    2,    2,    0],

    # Same as before, but with explicit EXP around it
    [f"ETDRK(EXP(lg),ADDT(lc,lb,n),{o})",        2,    2,    0],
]
