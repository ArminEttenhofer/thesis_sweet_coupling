...
class Spharmt(object):
    ...
    """
    def __init__(self,nlons,nlats,ntrunc,rsphere2d,gridtype='gaussian'):
        """initialize
        ...
        self.lap = self.lap/rsphere2d**2
        self.invlap = self.invlap*rsphere2d**2
    ...
    def getvrtdivspec(self,u,v):
        ...
        return self.lap*self.rsphere2d*vrtspec, self.lap*rsphere2d*divspec
...
if __name__ == "__main__":
    ...
    rsphere2d = 6.37122e6 # earth radius
    omega = 7.292e-5 # rotation rate
    grav = 9.80616 # gravity
    h0 = 10000 # average height
    umax = 80. # jet speed
    phi0 = np.pi/7.
    phi1 = 0.5*np.pi - phi0
    phi2 = 0.25*np.pi
    ...
    x = Spharmt(nlons,nlats,ntrunc,rsphere2d,gridtype='gaussian')
    ...
    def setup(add_bump, analytical):
        ...
        #
        # Ensure average of 10e3
        #
        # eliminate 0th mode to set average to 0
        phispec[0] = 0
