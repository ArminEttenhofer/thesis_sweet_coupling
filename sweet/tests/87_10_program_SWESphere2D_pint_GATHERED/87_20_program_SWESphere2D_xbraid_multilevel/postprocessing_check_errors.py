...
JobsData_GroupsCleanupPostprocessed(job_groups, tag_cleanup_info, pickle_file_default_prefix="sphere2d_data_norms_grid_space_", pint = True)
...
for key, group in job_groups.items():
    ...
    while True:
        ...
        for i in vars_:
            ...
            ## get offline errors
            try:
                err_offline['res_norm_linf'] = group[offline_job][f"sphere2d_data_diff_prog_{i}.res_norm_linf" + niter_str]
                err_offline['res_norm_l1'] = group[offline_job][f"sphere2d_data_diff_prog_{i}.res_norm_l1" + niter_str]
                err_offline['res_norm_l2'] = group[offline_job][f"sphere2d_data_diff_prog_{i}.res_norm_l2" + niter_str]
            except:
                br = True
                break
