...
##for tsm_fine in ../../src/programs/swe_sphere2d_timeintegrators/SWE_Sphere2D_TS*hpp; do ## full version
...
###for tsm_fine in l_irk_na_sl_settls_uv_only; do ## short version
	...
	##for tsm_coarse in ../../src/programs/swe_sphere2d_timeintegrators/SWE_Sphere2D_TS*hpp; do ## full version
