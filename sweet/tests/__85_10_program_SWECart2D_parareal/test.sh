...
for i in {0,1,2};do
	##for tsm_fine in ../../src/programs/swe_cart2d_timeintegrators/SWE_Cart2D_TS*hpp; do ## full version
	...
	##for tsm_fine in l_cn; do ## short version
		...
		##for tsm_coarse in ../../src/programs/swe_cart2d_timeintegrators/SWE_Cart2D_TS*hpp; do ## full version
