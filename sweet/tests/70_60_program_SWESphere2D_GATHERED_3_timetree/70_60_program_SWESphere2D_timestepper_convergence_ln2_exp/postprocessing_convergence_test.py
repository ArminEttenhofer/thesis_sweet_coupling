...
for tagname_y in tagnames_y:
    ...
    if True:
        ...
        for group_name, group_data in d.get_data_float().items():
            ...
            error_tolerance_convergence = None
            error_tolerance_error = None

            # Deactivated because of nonlinearities
            if False and ( 'exp' in group_name.lower() or 'rexi' in group_name.lower() ):
                #
                # DEACTIVATED because of NL
                #
