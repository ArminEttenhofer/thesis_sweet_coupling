...
Runtime parameters
"""
params_runtime_timestep_sizes = [30., 60., 120., 360., 960., 1920.] # [s]
total_simtime = 60 * 60 * 24 * 15 # 15 days

jg.runtime.benchmark_name = 'williamson5'
...
ts_methods = ["LRK(lg,ADDT(lb,lc,n),o=2)", "LRK(lg,ADDT(lb,lc,n),o=3)", "LRK(lg,ADDT(lb,lc,n),o=4)", \
                "ETDRK(lg,ADDT(lb,lc,n),o=2)", "ETDRK(lg,ADDT(lb,lc,n),o=4)"]
