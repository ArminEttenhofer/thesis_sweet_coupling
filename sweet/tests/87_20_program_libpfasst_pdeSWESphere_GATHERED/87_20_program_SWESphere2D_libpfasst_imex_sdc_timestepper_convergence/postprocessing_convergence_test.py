...
for i in vars_:
    ...
    ref_files = glob.glob(f"job_benchref_REFJOB_*/output_prog_{i}_*.sweet")
    ref_files.sort()
    ...
    """
    tag_cleanup_info += [
        {"ref_file_starts_with": ref_file, "tag_src": "res_norm_l1", "tag_dst": f"sphere2d_data_diff_prog_{i}.res_norm_l1"},
        {"ref_file_starts_with": ref_file, "tag_src": "res_norm_l2", "tag_dst": f"sphere2d_data_diff_prog_{i}.res_norm_l2"},
        {"ref_file_starts_with": ref_file, "tag_src": "res_norm_linf", "tag_dst": f"sphere2d_data_diff_prog_{i}.res_norm_linf"},
    ]
