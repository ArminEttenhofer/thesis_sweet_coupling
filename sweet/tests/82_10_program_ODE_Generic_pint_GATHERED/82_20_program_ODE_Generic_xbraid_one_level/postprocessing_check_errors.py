...
for i in vars_:
    tagnames_y += [
        f"scalar_data_diff_prog_{i}.res_norm_linf",
    ]

    tag_cleanup_info += [
        {"ref_file_starts_with": f"output_prog_{i}", "tag_src": "res_norm_linf", "tag_dst": f"scalar_data_diff_prog_{i}.res_norm_linf"},
    ]
...
JobsData_GroupsCleanupPostprocessed(job_groups, tag_cleanup_info, pickle_file_default_prefix="scalar_data_norms_grid_space_")
