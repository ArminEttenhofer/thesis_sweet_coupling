    ...
    def __setup(
        ...
        for f in files:
            ...
            if platform_id in platforms:
                ...
                self.info(msg)
                msg = " + Error happened in module '"+platforms[platform_id].module.__name__+"' and '"+module.__name__+"'\n"
                self.info(msg)
                self.error(msg)
        ...
        if self.platform_id_override != None:
            if self.platform_id_override not in platforms:
                self.error("Platform override error: Platform with id '"+self.platform_id_override+"' not found")

            self.platform = platforms[self.platform_id_override]
