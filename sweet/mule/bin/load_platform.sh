#
# This file can only be included
#
# It sets up the environment for a given platform.
#
# The first argument to this script can be:
#
# * [empty]: No argument will autodetect the platform
#
# * 'auto': Used to autodetect the platform
#
# * [platform_id]: The platform ID itself to avoid autodetection
#
#
# The environment variable
# 'MULE_PLATFORM_ID' can be also set for manually choosing the right platform
#
...
if [[ "#$1" != "#" && "#$1" != "#auto" ]]; then
	...
	PLATFORM_ENV_VARS=$(eval echo "${MULE_ROOT}/platforms/"??"_$MULE_PLATFORM_ID/env_vars.sh")
