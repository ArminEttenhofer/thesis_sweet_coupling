...
class MyDataContainer :
	public sweet::Data::GenericContainer::DESolver_DataContainer_Base
{
public:
...
private:
	static inline
	MyDataContainer& cast(sweet::Data::GenericContainer::DESolver_DataContainer_Base &i_U)
	{
...
private:
	static inline
	const MyDataContainer& cast(const sweet::Data::GenericContainer::DESolver_DataContainer_Base &i_U)
	{
...
public:
	void setup_like(
		const sweet::Data::GenericContainer::DESolver_DataContainer_Base &i_a
	) override
	{
...
public:
	void op_setVectorPlusVector(
			const sweet::Data::GenericContainer::DESolver_DataContainer_Base &i_a,
			const sweet::Data::GenericContainer::DESolver_DataContainer_Base &i_b
	) override
	{
		for (std::size_t i = 0; i < data.size(); i++)
...
public:
	 ...
	 */
	sweet::Data::GenericContainer::DESolver_DataContainer_Base* getNewDataContainerInstance(
			int i_id = -1
	) const override
	{
		MyDataContainer *retval = new MyDataContainer;
...
template <int N>
class MyODETerm	:
		public sweet::TimeTree::TimeTree_Node_Base
{
public:
...
private:
	...
	bool setupFunction(
			std::shared_ptr<sweet::TimeTree::DESolver_TimeStepping_Tree::Function> &i_function,
	...
	std::shared_ptr<sweet::TimeTree::TimeTree_Node_Base> getInstanceNew() override
	{
		return std::shared_ptr<sweet::TimeTree::TimeTree_Node_Base>(new MyODETerm);
	}

	const MyDESolver_Config& cast(const sweet::Data::GenericContainer::ConfigBase &i_config)
	{
	...
	) override
	{
		...
		SWEET_ASSERT(_polynomialsForTerms != nullptr);
	...
	void eval_tendencies(
			const sweet::Data::GenericContainer::DESolver_DataContainer_Base &i_U,
			sweet::Data::GenericContainer::DESolver_DataContainer_Base &o_U,
			double i_timeStamp
	)	override
	{
...
public:
	...
	std::shared_ptr<sweet::TimeTree::TimeTree_Node_Base> timeStepper;
	...
	bool setup_4_timestepper()
	{
		...
		sweet::TimeTree::DESolver_TimeStepping_Tree tsTree;
		 ...
		 * Register DE Terms
		 */
		//sweet::TimeTree::DESolver_DETerm_Registry pdeTerm_registry;
		sweet::TimeTree::TimeTree_Registry pdeTerm_registry;
		 ...
		 */
		sweet::TimeTree::TimeStepperRegistry tsRegistryAll;

		sweet::TimeTree::TimeTree_Registry timeStepper_registry;
