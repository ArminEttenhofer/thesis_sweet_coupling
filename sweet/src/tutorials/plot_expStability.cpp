...
int main()
{
	...
	sweet::ExpIntegration::ExpFunction<T> phi0("phi0");
	sweet::ExpIntegration::ExpFunction<T> phi1("phi1");
	sweet::ExpIntegration::ExpFunction<T> phi2("phi2");

	sweet::ExpIntegration::ExpFunction<T> ups1("ups1");
	sweet::ExpIntegration::ExpFunction<T> ups2("ups2");
	sweet::ExpIntegration::ExpFunction<T> ups3("ups3");
