...
void create_reference_array_float(
		sweet::Dict::TypesArrayND<D,sweet::Dict::Dict::float64> &io_array,
		sweet::Dict::Dict::float64 i_offset = 0
)
{
	...
	{
		SWEETErrorFatal("Only 1D, 2D and 3D supported");
	}
	...
	for (int i0 = 0; i0 < shape_iter[0]; i0++)
	{
		for (int i1 = 0; i1 < shape_iter[1]; i1++)
		{
			...
			{
				sweet::Dict::Dict::float64 test_value = i_offset + i0*shape_iter[1]*shape_iter[2] + i1*shape_iter[2] + i2;
...
void create_reference_array_complex(
		sweet::Dict::TypesArrayND<D,sweet::Dict::Dict::complex128> &io_array,
		sweet::Dict::Dict::float64 i_offset = 0
)
{
	std::array<int,3> shape_iter;
	...
	for (int i0 = 0; i0 < shape_iter[0]; i0++)
	{
		for (int i1 = 0; i1 < shape_iter[1]; i1++)
		{
			for (int i2 = 0; i2 < shape_iter[2]; i2++)
			{
				sweet::Dict::Dict::complex128 test_value = sweet::Dict::Dict::complex128(i_offset + c, 101+ i_offset + c);
				io_array.data()[c] = test_value;
				c++;
			}
		}
...
)
{
	...
	io_dict.set<sweet::Dict::Dict::int64>("int64", 123);
	io_dict.set<sweet::Dict::Dict::float64>("float64", 123.456);
	io_dict.set<sweet::Dict::Dict::complex128>("complex128", std::complex<double>(123.456, 123.456+100));

	sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::float64> array1dFloat64(i2);
	create_reference_array_float(array1dFloat64, 1);
	io_dict.set("array_float64_1d", array1dFloat64);

	sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::float64> array2dFloat64(i1, i2);
	create_reference_array_float(array2dFloat64, 1);
	io_dict.set("array_float64_2d", array2dFloat64);

	sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::float64> array3dFloat64(i0, i1, i2);
	create_reference_array_float(array3dFloat64, 1);
	io_dict.set("array_float64_3d", array3dFloat64);


	sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::complex128> array1dComplex64(i2);
	create_reference_array_complex(array1dComplex64, 1);
	io_dict.set("array_complex128_1d", array1dComplex64);

	sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::complex128> array2dComplex64(i1, i2);
	create_reference_array_complex(array2dComplex64, 1);
	io_dict.set("array_complex128_2d", array2dComplex64);

	sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::complex128> array3dComplex64(i0, i1, i2);
...
void compareDict1EntriesEqualDict2(
		const sweet::Dict::Dict &i_dict1,
		const sweet::Dict::Dict &i_dict2,
		const std::string &i_prefix
)
{
	for (int i = 0; i < i_dict1.getNumElements(); i++)
	{
		const sweet::Dict::_DictElement &e1 = i_dict1[i];

		const sweet::Dict::_DictElementTypeEnum::Enum typeId = e1.getTypeID();
		...
		switch(typeId)
		{
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_STRING:
			{
				...
				if (value1 != value2)
					SWEETErrorFatal("Values don't match");
			}
				break;

			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_INT64:
			{
				typedef sweet::Dict::Dict::int64 T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_FLOAT64:
			{
				typedef sweet::Dict::Dict::float64 T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_COMPLEX128:
			{
				typedef sweet::Dict::Dict::complex128 T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_1D_FLOAT64:
			{
				typedef sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::float64> T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_2D_FLOAT64:
			{
				typedef sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::float64> T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_3D_FLOAT64:
			{
				typedef sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::float64> T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_1D_COMPLEX128:
			{
				typedef sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::complex128> T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_2D_COMPLEX128:
			{
				typedef sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::complex128> T;
			...
			case sweet::Dict::_DictElementTypeEnum::SWEET_FILE_DICT_ARRAY_3D_COMPLEX128:
			{
				typedef sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::complex128> T;
...
void run_compare_file_dict_with_reference(
		const sweet::Dict::Dict &i_dict
)
{
	sweet::Dict::Dict ref_dict;
...
void run_sweet_array_assignment_test()
{
	...
	sweet::Dict::TypesArrayND<2,double> test_array;
	...
	for (int i0 = 0; i0 < test_array.shape()[0]; i0++)
	{
		...
		{
			sweet::Dict::Dict::float64 test_value = 1 + i0*test_array.shape()[1] + i1;
			sweet::Dict::Dict::float64 real_value = test_array.get(i0, i1);
...
)
{
	...
	{
		sweet::Dict::Dict::float64 data[3];
		for (int i = 0; i < size1d; i++)
			data[i] = i+1;

		if (version_id == 0)
		{
			sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::float64> array(shape1d, data);
		...
		if (version_id == 1)
		{
			sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::float64> array;
			array.setup(shape1d);
			array = data;
...

	{
		...
		sweet::Dict::Dict::float64 data[size2d];
		...
		if (version_id == 0)
		{
			sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::float64> array(shape, data);
		...
		if (version_id == 1)
		{
			sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::float64> array;
			array.setup(shape);
			array = data;
	...
	{
		sweet::Dict::Dict::float64 data[size3d];
		for (std::size_t i = 0; i < sizeof(data)/sizeof(sweet::Dict::Dict::float64); i++)
			data[i] = i+1;

		if (version_id == 0)
		{
			sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::float64> array(shape3d, data);
		...
		if (version_id == 1)
		{
			sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::float64> array;
			array.setup(shape3d);
			array = data;
	...
	{
		sweet::Dict::Dict::complex128 data[size1d];
		for (int i = 0; i < size1d; i++)
			data[i] = sweet::Dict::Dict::complex128(i+1, 100+i);

		if (version_id == 0)
		{
			sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::complex128> array(shape1d, data);
		...
		if (version_id == 1)
		{
			sweet::Dict::TypesArrayND<1,sweet::Dict::Dict::complex128> array;
			array.setup(shape1d);
			array = data;
...

	{
		...
		sweet::Dict::Dict::complex128 data[size2d];
		...
		if (version_id == 0)
		{
			sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::complex128> array(shape2d, data);
		...
		if (version_id == 1)
		{
			sweet::Dict::TypesArrayND<2,sweet::Dict::Dict::complex128> array;
			array.setup(shape2d);
			array = data;
...

	{
		...
		sweet::Dict::Dict::complex128 data[size3d];
		for (int i = 0; i < size3d; i++)
			data[i] = sweet::Dict::Dict::complex128(i+1, 100+i);

		if (version_id == 0)
		{
			sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::complex128> array(shape3d, data);
		...
		if (version_id == 1)
		{
			sweet::Dict::TypesArrayND<3,sweet::Dict::Dict::complex128> array;
			array.setup(shape3d);
			array = data;
...
void run_sweet_file_dict_creation_test()
{
	...
	sweet::Dict::Dict fileDict0;
	sweet::Dict::Dict fileDict1;
	sweet::Dict::Dict fileDict2;
...
public:
	...
	void printProgramArguments(const std::string& i_prefix = "") override
	{
		...
		std::cout << "	--sweet-file-dict [string]	Which dictionary to use to compare to" << std::endl;
		std::cout << "	--run-unit-test-sweet-file-dict [bool]	run further tests" << std::endl;
	...
	) override
	{
		std::cout << std::endl;
		std::cout << "User defined:" << std::endl;
		std::cout << " + sweet_file_dict: " << fileDict << std::endl;
		std::cout << " + run_unit_test_sweet_file_dict: " << runUnitTest << std::endl;
		std::cout << std::endl;
	}
};
...
)
{
	...
	if (shackUserDefined->fileDict != "")
	{
		 ...
		 */
		hline_star();
		std::cout << "+ Loading from file '" << shackUserDefined->fileDict << "'" << std::endl;
		hline_star();

		sweet::Dict::Dict fd(shackUserDefined->fileDict, false);
		//std::cout << fd << std::endl;

		/*
		 * Should we also run tests on it?
		 */
		if (shackUserDefined->runUnitTest)
		{
			hline_star();
			std::cout << " + Create reference dictionary and compare with data from file" << std::endl;
			hline_star();
			run_compare_file_dict_with_reference(shackUserDefined->fileDict);
		}
	}
