...
)
{
	...
	sweet::Data::Sphere2D::Operators ops(i_sphere2DDataConfig, i_shackSphere2DDataOps);
	...
	if (true)
	{
...

		{
			...
			for (int i = 0; i < sizeof(alpha)/sizeof(double); i++)
			{
				...
				sweet::Data::Sphere2D::DataGrid u(i_sphere2DDataConfig);
				...
				sweet::Data::Sphere2D::DataGrid v(i_sphere2DDataConfig);
				...
				sweet::Data::Sphere2D::DataSpectral vort(i_sphere2DDataConfig);
...

	{
		...
		if (true)
		{
			...
			sweet::Data::Sphere2D::DataSpectral data(i_sphere2DDataConfig);
			sweet::Data::Sphere2D::DataGrid data_phys(i_sphere2DDataConfig);
			...
			sweet::Data::Sphere2D::DataSpectral data2(i_sphere2DDataConfig);
			sweet::Data::Sphere2D::DataGrid data2_phys(i_sphere2DDataConfig);
		...
		if (true)
		{
			...
			sweet::Data::Sphere2D::DataSpectral h(i_sphere2DDataConfig);
			sweet::Data::Sphere2D::DataGrid h_phys(i_sphere2DDataConfig);
			...
			sweet::Data::Sphere2D::DataSpectral hphi(i_sphere2DDataConfig);
			sweet::Data::Sphere2D::DataGrid hphi_phys(i_sphere2DDataConfig);
		...
		if (true)
		{
			...
			sweet::Data::Sphere2D::DataSpectral result(i_sphere2DDataConfig);
			sweet::Data::Sphere2D::DataGrid result_phys(i_sphere2DDataConfig);
