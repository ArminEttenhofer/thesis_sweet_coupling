...
#ifndef TESTS_CORE_SPHERE2D_SPHOPERATORS_SPHERE2DTESTSOLUTIONS_GAUSSIAN_HPP
#define TESTS_CORE_SPHERE2D_SPHOPERATORS_SPHERE2DTESTSOLUTIONS_GAUSSIAN_HPP

#include <cmath>


class Sphere2DTestSolutions_Gaussian
{
	double exp_fac = 10.0;
#if 0
...
public:
	Sphere2DTestSolutions_Gaussian(
