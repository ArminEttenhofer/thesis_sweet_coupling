 ...
 * MULE_COMPILE_FILES_AND_DIRS: src/programs/PDE_SWESphere2D/DataContainer/
 ...
 * MULE_SCONS_OPTIONS: --xbraid-sphere2d=enable
 */

#include "PDE_SWESphere2D/XBraid/Program.hpp"
...
int main(int i_argc, char *i_argv[])
{
	...
	PDE_SWESphere2D::XBraid::Program simulation(
						i_argc, i_argv
#if SWEET_MPI
						,
						MPI_COMM_WORLD,
