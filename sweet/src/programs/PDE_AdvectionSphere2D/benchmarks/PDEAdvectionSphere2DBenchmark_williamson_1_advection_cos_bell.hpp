...
#ifndef PROGRAMS_PDE_ADVECTIONSPHERE2D_BENCHMARKS_PDEADVECTIONSPHERE2DBENCHMARK_WILLIAMSON_1_ADVECTION_COS_BELL_HPP
#define PROGRAMS_PDE_ADVECTIONSPHERE2D_BENCHMARKS_PDEADVECTIONSPHERE2DBENCHMARK_WILLIAMSON_1_ADVECTION_COS_BELL_HPP
...
class PDEAdvectionSphere2DBenchmark_williamson_1_advection_cos_bell	:
	public PDEAdvectionSphere2DBenchmarks_BaseInterface
{
	double _default_sphere2d_radius = 6.37122e6;

public:
	PDEAdvectionSphere2DBenchmark_williamson_1_advection_cos_bell()
	{
	}
