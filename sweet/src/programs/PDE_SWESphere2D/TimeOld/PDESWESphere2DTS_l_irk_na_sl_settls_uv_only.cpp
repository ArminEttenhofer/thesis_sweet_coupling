...
bool PDESWESphere2DTS_l_irk_na_sl_settls_uv_only::implementsTimesteppingMethod(const std::string &i_timestepping_method)
{
...
bool PDESWESphere2DTS_l_irk_na_sl_settls_uv_only::setup_auto(
...
bool PDESWESphere2DTS_l_irk_na_sl_settls_uv_only::setup_main(
...
)
{
	...
	swe_sphere2d_ts_l_irk.setup(ops, 1, 0.5 * shackTimestepControl->currentTimestepSize);
...
std::string PDESWESphere2DTS_l_irk_na_sl_settls_uv_only::getIDString()
{
...
void PDESWESphere2DTS_l_irk_na_sl_settls_uv_only::runTimestep(
...
void PDESWESphere2DTS_l_irk_na_sl_settls_uv_only::run_timestep_2nd_order_pert(
...
)
{
	 ...
	 */
		...
		swe_sphere2d_ts_ln_erk_split_uv__l_erk_1st_order.euler_timestep_update_pert_nr(
...
PDESWESphere2DTS_l_irk_na_sl_settls_uv_only::PDESWESphere2DTS_l_irk_na_sl_settls_uv_only()
{
}
