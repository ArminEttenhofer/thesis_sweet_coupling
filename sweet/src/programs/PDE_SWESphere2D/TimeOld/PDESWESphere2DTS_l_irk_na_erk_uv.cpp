...
bool PDESWESphere2DTS_l_irk_na_erk_uv::setup_auto(
 ...
 * Setup
 */
bool PDESWESphere2DTS_l_irk_na_erk_uv::setup_main(
...
bool PDESWESphere2DTS_l_irk_na_erk_uv::implementsTimesteppingMethod(const std::string &i_timestepping_method)
{
	timestepping_method = i_timestepping_method;
...
std::string PDESWESphere2DTS_l_irk_na_erk_uv::getIDString()
{
...
void PDESWESphere2DTS_l_irk_na_erk_uv::runTimestep(
...
PDESWESphere2DTS_l_irk_na_erk_uv::PDESWESphere2DTS_l_irk_na_erk_uv()	:
		version_id(0)
{
