/*
 * PDESWESphere2DTS_l_irk_na_sl_nr_settls_vd_only.hpp
 *
...
#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_L_IRK_NA_SL_NR_SETTLS_VD_ONLY_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_L_IRK_NA_SL_NR_SETTLS_VD_ONLY_HPP
...
class PDESWESphere2DTS_l_irk_na_sl_nr_settls_vd_only	: public PDESWESphere2DTS_BaseInterface
{
...
private:
	...
	PDESWESphere2DTS_ln_erk_split_vd swe_sphere2d_ts_ln_erk_split_vd__l_erk_1st_order;
...
public:
	...
	) override
	{
		...
		swe_sphere2d_ts_ln_erk_split_vd__l_erk_1st_order.shackRegistration(io_shackDict);
...
public:
	PDESWESphere2DTS_l_irk_na_sl_nr_settls_vd_only();
	...
	virtual ~PDESWESphere2DTS_l_irk_na_sl_nr_settls_vd_only();
};
