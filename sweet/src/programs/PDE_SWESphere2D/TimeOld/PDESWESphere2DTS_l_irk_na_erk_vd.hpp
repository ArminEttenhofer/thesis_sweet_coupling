...
#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_L_IRK_NA_ERK_VD_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_L_IRK_NA_ERK_VD_HPP
...
class PDESWESphere2DTS_l_irk_na_erk_vd	: public PDESWESphere2DTS_BaseInterface
{
public:
	bool setup_auto(
...
public:
	 ...
	 */
	PDESWESphere2DTS_ln_erk_split_vd timestepping_na_erk_split_vd;
...
public:
	PDESWESphere2DTS_l_irk_na_erk_vd();
	...
	virtual ~PDESWESphere2DTS_l_irk_na_erk_vd();
};
