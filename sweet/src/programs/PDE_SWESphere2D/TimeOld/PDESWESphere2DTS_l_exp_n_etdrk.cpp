...
bool PDESWESphere2DTS_l_exp_n_etdrk::shackRegistration(sweet::Shacks::Dictionary *io_shackDict)
{
...
bool PDESWESphere2DTS_l_exp_n_etdrk::implementsTimesteppingMethod(const std::string &i_timestepping_method)
{
...
std::string PDESWESphere2DTS_l_exp_n_etdrk::getIDString()
{
	return "l_exp_n_etdrk";
}

bool PDESWESphere2DTS_l_exp_n_etdrk::setup_auto(
 ...
 * Setup
 */
bool PDESWESphere2DTS_l_exp_n_etdrk::setup_main(
...
)
{
	...
	{
		ts_phi0_exp.setup_variant_100(ops, i_shackExpIntegration, "phi0", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_phi1_exp.setup_variant_100(ops, i_shackExpIntegration, "phi1", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
	}
	else if (timestepping_order == 2)
	{
		ts_phi0_exp.setup_variant_100(ops, i_shackExpIntegration, "phi0", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_phi1_exp.setup_variant_100(ops, i_shackExpIntegration, "phi1", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_phi2_exp.setup_variant_100(ops, i_shackExpIntegration, "phi2", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
	}
	else if  (timestepping_order == 4)
	{
		ts_phi0_exp.setup_variant_100(ops, i_shackExpIntegration, "phi0", i_exp_method, i_timestepSize*0.5, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_phi1_exp.setup_variant_100(ops, i_shackExpIntegration, "phi1", i_exp_method, i_timestepSize*0.5, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_phi2_exp.setup_variant_100(ops, i_shackExpIntegration, "phi2", i_exp_method, i_timestepSize*0.5, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);

		// phi0, but with a full time step size
		ts_ups0_exp.setup_variant_100(ops, i_shackExpIntegration, "phi0", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_ups1_exp.setup_variant_100(ops, i_shackExpIntegration, "ups1", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_ups2_exp.setup_variant_100(ops, i_shackExpIntegration, "ups2", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
		ts_ups3_exp.setup_variant_100(ops, i_shackExpIntegration, "ups3", i_exp_method, i_timestepSize, false, false, timestepping_order, i_use_rexi_sphere2d_solver_preallocation);
	}
	else
	{
...
void PDESWESphere2DTS_l_exp_n_etdrk::runTimestep(
...
{
	const sweet::Data::Sphere2D::Config *sphere2DDataConfig = io_phi.sphere2DDataConfig;
	...
	if (timestepping_order == 1)
	{
		...
		sweet::Data::Sphere2D::DataSpectral phi0_Un_phi(sphere2DDataConfig), phi0_Un_vrt(sphere2DDataConfig), phi0_Un_div(sphere2DDataConfig);
		...
		sweet::Data::Sphere2D::DataSpectral FUn_phi(sphere2DDataConfig), FUn_vrt(sphere2DDataConfig), FUn_div(sphere2DDataConfig);
		...
		sweet::Data::Sphere2D::DataSpectral phi1_FUn_phi(sphere2DDataConfig), phi1_FUn_vrt(sphere2DDataConfig), phi1_FUn_div(sphere2DDataConfig);
	...
	if (timestepping_order == 4)
	{
		...
		sweet::Data::Sphere2D::DataSpectral phi1_h(sphere2DDataConfig), phi1_u(sphere2DDataConfig), phi1_v(sphere2DDataConfig);
		...
		sweet::Data::Sphere2D::DataSpectral phi0_An_h(sphere2DDataConfig), phi0_An_u(sphere2DDataConfig), phi0_An_v(sphere2DDataConfig);
		...
		sweet::Data::Sphere2D::DataSpectral FBn_h(sphere2DDataConfig), FBn_u(sphere2DDataConfig), FBn_v(sphere2DDataConfig);
		 ...
		 * R0 - R3
		 */
		sweet::Data::Sphere2D::DataSpectral FCn_h(sphere2DDataConfig), FCn_u(sphere2DDataConfig), FCn_v(sphere2DDataConfig);
		...
		sweet::Data::Sphere2D::DataSpectral R0_h = io_phi;
...
PDESWESphere2DTS_l_exp_n_etdrk::PDESWESphere2DTS_l_exp_n_etdrk()
{
}
