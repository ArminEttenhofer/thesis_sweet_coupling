...
#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LG_IRK_LC_N_ERK_VER01_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LG_IRK_LC_N_ERK_VER01_HPP
...
class PDESWESphere2DTS_lg_irk_lc_n_erk	: public PDESWESphere2DTS_BaseInterface
{
public:
	bool setup_auto(
...
public:
	PDESWESphere2DTS_lg_irk_lc_n_erk();
	...
	virtual ~PDESWESphere2DTS_lg_irk_lc_n_erk();
};
