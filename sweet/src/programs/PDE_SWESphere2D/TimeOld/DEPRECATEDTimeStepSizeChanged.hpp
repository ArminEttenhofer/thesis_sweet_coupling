...
#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_DEPRECATEDTIMESTEPSIZECHANGED_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_DEPRECATEDTIMESTEPSIZECHANGED_HPP

#include <algorithm>
#include <iostream>


class DEPRECATED_TimeStepSizeChanged
{
	/*
