...
#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LG_EXP_LC_ERK_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LG_EXP_LC_ERK_HPP
...
class PDESWESphere2DTS_lg_exp_lc_erk	: public PDESWESphere2DTS_BaseInterface
{
public:
	bool setup_auto(
...
private:
	 ...
	 */
	PDESWESphere2DTS_l_exp timestepping_l_exp;
...
public:
	PDESWESphere2DTS_lg_exp_lc_erk();
	...
	virtual ~PDESWESphere2DTS_lg_exp_lc_erk();
};
