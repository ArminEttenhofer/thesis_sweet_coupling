...
#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LG_EXP_LC_N_ETD_VD_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LG_EXP_LC_N_ETD_VD_HPP
...
class PDESWESphere2DTS_lg_exp_lc_n_etd_vd	: public PDESWESphere2DTS_BaseInterface
{
public:
	bool setup_auto(
...
private:
	PDESWESphere2DTS_ln_erk_split_vd ts_ln_erk_split_vd;
...
public:
	PDESWESphere2DTS_lg_exp_lc_n_etd_vd();
	...
	virtual ~PDESWESphere2DTS_lg_exp_lc_n_etd_vd();
};
