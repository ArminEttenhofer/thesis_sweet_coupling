/*
 * PDESWESphere2DTS_l_irk_na_sl_settls_vd_only.hpp
 *
...
#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_L_IRK_NA_SL_SETTLS_VD_ONLY_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_L_IRK_NA_SL_SETTLS_VD_ONLY_HPP
...
class PDESWESphere2DTS_l_irk_na_sl_settls_vd_only	: public PDESWESphere2DTS_BaseInterface
{
public:
	bool setup_auto(
...
public:
	PDESWESphere2DTS_l_irk_na_sl_settls_vd_only();
	...
	virtual ~PDESWESphere2DTS_l_irk_na_sl_settls_vd_only();
};
