/*
 * PDESWESphere2DTS_ln_settls.hpp
 *
 *  Created on: 24 Sep 2019
 * Author: Martin SCHREIBER <schreiberx@gmail.com>
 */

#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LN_SL_EXP_SETTLS_VD_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMEOLD_PDESWESPHERE2DTS_LN_SL_EXP_SETTLS_VD_HPP
...
class PDESWESphere2DTS_ln_sl_exp_settls_vd	: public PDESWESphere2DTS_BaseInterface
{
public:
...
private:
	...
	PDESWESphere2DTS_ln_erk_split_vd swe_sphere2d_ts_ln_erk_split_vd;
	PDESWESphere2DTS_l_exp swe_sphere2d_ts_l_exp;
...
public:
	...
	) override
	{
		...
		swe_sphere2d_ts_ln_erk_split_vd.shackRegistration(io_shackDict);
		swe_sphere2d_ts_l_exp.shackRegistration(io_shackDict);
		return true;
	}


public:
	PDESWESphere2DTS_ln_sl_exp_settls_vd();
	...
	virtual ~PDESWESphere2DTS_ln_sl_exp_settls_vd();
};
