...
bool PDESWESphere2DTS_l_irk_na_sl_settls_vd_only::implementsTimesteppingMethod(const std::string &i_timestepping_method)
{
...
bool PDESWESphere2DTS_l_irk_na_sl_settls_vd_only::setup_auto(
...
bool PDESWESphere2DTS_l_irk_na_sl_settls_vd_only::setup_main(
...
)
{
	...
	swe_sphere2d_ts_ln_erk_split_vd__l_erk_1st_order.setup_main(ops, 1, true, true, false, false, false);
...
std::string PDESWESphere2DTS_l_irk_na_sl_settls_vd_only::getIDString()
{
...
void PDESWESphere2DTS_l_irk_na_sl_settls_vd_only::runTimestep(
...
)
{
	...
	{
		SWEETErrorFatal("Only orders 1/2 supported");
	}
}



void PDESWESphere2DTS_l_irk_na_sl_settls_vd_only::run_timestep_2nd_order(
...
PDESWESphere2DTS_l_irk_na_sl_settls_vd_only::PDESWESphere2DTS_l_irk_na_sl_settls_vd_only()
{
}
