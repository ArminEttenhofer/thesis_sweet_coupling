#ifndef PROGRAMS_PDE_SWESPHERE2D_XRAID_DATACONTAINER_HPP
#define PROGRAMS_PDE_SWESPHERE2D_XRAID_DATACONTAINER_HPP
...
public:
	...
	PDE_SWESphere2D::DataContainer::Simulation*		data = nullptr;
...
public:
	...
	{
		data = new PDE_SWESphere2D::DataContainer::Simulation;
	...
	void restrict(sweet::XBraid::Vector* i_data) override
	{
		...
		PDE_SWESphere2D::XBraid::DataContainer* data2 = cast(i_data);
