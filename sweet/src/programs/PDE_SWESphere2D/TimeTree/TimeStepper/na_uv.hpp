#ifndef PROGRAMS_PDE_SWESPHERE2D_TIMETREE_TIMESTEPPER_NA_UV_HPP
#define PROGRAMS_PDE_SWESPHERE2D_TIMETREE_TIMESTEPPER_NA_UV_HPP
...
/*!
 * Provide the nonlinear advection part using both velocities u and v as advected variables.
 */
class na_uv	:
	public sweet::TimeTree::TimeTree_Node_LeafHelper<na_uv>,
