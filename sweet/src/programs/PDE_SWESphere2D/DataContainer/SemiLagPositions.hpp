#ifndef PROGRAMS_PDE_SWESPHERE2D_DATACONTAINER_SEMILAGPOSITIONS_HPP
#define PROGRAMS_PDE_SWESPHERE2D_DATACONTAINER_SEMILAGPOSITIONS_HPP
...
public:
	...
	sweet::Data::Vector::Vector<double> &lon = data[0];
	sweet::Data::Vector::Vector<double> &lat = data[1];
...
public:
	...
	{
		for (int i = 0; i < N; i++)
			data[i].setup(i_sphere2DData_Config->grid_number_elements);
	}
