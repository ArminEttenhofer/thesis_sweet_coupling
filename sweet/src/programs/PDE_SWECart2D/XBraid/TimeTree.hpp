#ifndef PROGRAMS_PDE_SWECART2D_XBRAID_TIMETREE_HPP
#define PROGRAMS_PDE_SWECART2D_XBRAID_TIMETREE_HPP
...
public:
	...
	PDE_SWECart2D::TimeTree::TimeTree* tsm = nullptr;

public:

	TimeTree()
	{
		tsm = new PDE_SWECart2D::TimeTree::TimeTree;
	}
...
public:
	void setup(
			...
			PDE_SWECart2D::XBraid::DataContainer* i_u,
			double i_dt
	)
	{
...
public:
	...
	)
	{
		...
		PDE_SWECart2D::XBraid::DataContainer* U1 = (PDE_SWECart2D::XBraid::DataContainer*) i_U;
		PDE_SWECart2D::XBraid::DataContainer* U2 = (PDE_SWECart2D::XBraid::DataContainer*) o_U;
