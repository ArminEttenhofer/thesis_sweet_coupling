#ifndef PROGRAMS_PDE_SWECART2D_XBRAID_APP_HPP
#define PROGRAMS_PDE_SWECART2D_XBRAID_APP_HPP
...
public:
	...
	std::vector<PDE_SWECart2D::Shack*>			shacksModel_levels;
...
public:
	...
	)
	{
		...
		for (int level = 0; level < shackXBraid->xbraid_max_levels; level++)
		{
			...
			PDE_SWECart2D::Shack* shackModel_level = nullptr;
			sweet::Data::Cart2D::Shack* shackDataOps_level = nullptr;

			shackModel_level = shacksDict_levels[level]->getAutoRegistration<PDE_SWECart2D::Shack>();
...
public:
	bool setupDataConfigOps() override
	{
		...
		for (int level = 0; level < shackXBraid->xbraid_max_levels; level++)
		{
			data_container.push_back(new PDE_SWECart2D::XBraid::DataContainer);
			if (shackXBraid->xbraid_spatial_coarsening)
			{
				...
				config_levels.push_back(new sweet::Data::Cart2D::Config);
				config_levels.back()->setupAuto(shacksDataOps_levels[level]);
				op_levels.push_back(new sweet::Data::Cart2D::Operators(config_levels.back(), shacksDataOps_levels[level]));
				op_complex_levels.push_back(new sweet::Data::Cart2DComplex::Operators(config_levels.back(), shacksDataOps_levels[level]));
			...
			PDE_SWECart2D::XBraid::DataContainer* data_container2 = (PDE_SWECart2D::XBraid::DataContainer*) data_container.back();
	...
	{
		PDE_SWECart2D::XBraid::DataContainer* U = (PDE_SWECart2D::XBraid::DataContainer*) i_U;
		sweet::XBraid::Vector* v = createNewVector(U->level);
		PDE_SWECart2D::XBraid::DataContainer* V = (PDE_SWECart2D::XBraid::DataContainer*) v;
...
public:
	...
	{
		sweet::XBraid::Vector* U = new PDE_SWECart2D::XBraid::DataContainer;
		PDE_SWECart2D::XBraid::DataContainer* U2 = (PDE_SWECart2D::XBraid::DataContainer*) U;
	...
	sweet::XBraid::TimeTree* createConfigureNewTimestepper(int i_level) override
	{
		...
		sweet::XBraid::TimeTree* tsm = new PDE_SWECart2D::XBraid::TimeTree;
		PDE_SWECart2D::XBraid::TimeTree* tsm2 = (PDE_SWECart2D::XBraid::TimeTree *) tsm;
		PDE_SWECart2D::XBraid::DataContainer* U = (PDE_SWECart2D::XBraid::DataContainer*) prog_initial_solution;
