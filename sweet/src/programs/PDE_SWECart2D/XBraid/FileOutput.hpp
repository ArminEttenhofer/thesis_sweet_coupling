#ifndef PROGRAMS_PDE_SWECART2D_XBRAID_FILEOUTPUT_HPP
#define PROGRAMS_PDE_SWECART2D_XBRAID_FILEOUTPUT_HPP
	...
	public sweet::XBraid::FileOutput
{
	...
	PDE_SWECart2D::FileOutput file_output;

	sweet::Data::Cart2D::Shack* shackDataOps = nullptr;
	PDE_SWECart2D::Shack* shackModel = nullptr;
	sweet::Data::Cart2D::Config* config = nullptr;
	sweet::Data::Cart2D::Operators* ops = nullptr;
	sweet::Data::Cart2DComplex::Operators* opsComplex = nullptr;
...
public:
	bool setup(
			...
			sweet::Data::Cart2D::Shack* i_shackDataOps,
			PDE_SWECart2D::Shack* i_shackModel,
		...
		)
	{
		...
		file_output.setup(shackIOData, shackTimestepControl, shackDataOps, shackModel, config, ops, opsComplex);
		return true;
	}
...
public:
	...
	{
		PDE_SWECart2D::XBraid::DataContainer* U = (PDE_SWECart2D::XBraid::DataContainer*) i_vector;
