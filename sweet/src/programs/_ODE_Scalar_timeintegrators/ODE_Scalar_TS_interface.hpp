...
#ifndef PROGRAMS__ODE_SCALAR_TIMEINTEGRATORS_ODE_SCALAR_TS_INTERFACE_HPP
#define PROGRAMS__ODE_SCALAR_TIMEINTEGRATORS_ODE_SCALAR_TS_INTERFACE_HPP
...
public:
	...
	{
		param_parareal_function_a = i_a;
		param_parareal_function_b = i_b;
	}
