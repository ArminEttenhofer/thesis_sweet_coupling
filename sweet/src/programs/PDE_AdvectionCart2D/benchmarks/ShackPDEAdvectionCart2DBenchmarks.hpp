...
#ifndef PROGRAMS_PDE_ADVECTIONCART2D_BENCHMARKS_SHACKPDEADVECTIONCART2DBENCHMARKS_HPP
#define PROGRAMS_PDE_ADVECTIONCART2D_BENCHMARKS_SHACKPDEADVECTIONCART2DBENCHMARKS_HPP
 ...
 */
class ShackPDEAdvectionCart2DBenchmarks	:
...
public:
	...
	void (*getExternalForcesCallback)(int, double, sweet::Data::Cart2D::DataSpectral*, ShackPDEAdvectionCart2DBenchmarks*) = nullptr;
