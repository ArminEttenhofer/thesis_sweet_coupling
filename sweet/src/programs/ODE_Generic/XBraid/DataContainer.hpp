#ifndef PROGRAMS_ODE_GENERIC_XBRAID_DATACONTAINER_HPP
#define PROGRAMS_ODE_GENERIC_XBRAID_DATACONTAINER_HPP
...
public:
	...
	sweet::Data::GenericContainer::Base*		data = nullptr;
	/////ODE_Generic::DataContainer::Simulation*		data = nullptr;
...
public:
	...
	//{
	//	const DataContainer &U = cast(*this);
	//	U.data->data[0] = i_value;
	//}
