#ifndef PROGRAMS_ODE_GENERIC_DE_DALHQUIST_XBRAID_DATACONTAINER_HPP
#define PROGRAMS_ODE_GENERIC_DE_DALHQUIST_XBRAID_DATACONTAINER_HPP
...
class DataContainer :
	public ODE_Generic::XBraid::DataContainer
{

public:
	ODE_Generic::DE_Dahlquist::DataContainer::Simulation* data2;
...
public:
	...
	{
		data = new ODE_Generic::DE_Dahlquist::DataContainer::Simulation;
		data2 = (ODE_Generic::DE_Dahlquist::DataContainer::Simulation*) data;
...
//////	void allocate_data() override
//////	{
//////		data = new ODE_Generic::DataContainer::Simulation;
//////		///data_tmp = new ODE_Generic::DataContainer::Simulation;
//////
//////		data->setup(this->config);
//////		///data_tmp->setup(this->config);
//////	}
//////
//////	void restrict(sweet::XBraid::Vector* i_data) override
//////	{
//////
//////		ODE_Generic::XBraid::DataContainer* data2 = cast(i_data);
