 ...
 *
 * MULE_COMPILE_FILES_AND_DIRS: src/programs/libpfasst/PDE_SWESphere2D_imex_sdc/
...
#include "PDE_SWESphere2D_imex_sdc/Sphere2DDataCtxSDC.hpp"
...
int main(int i_argc, char *i_argv[])
{
	...
	/*if (shackDict.benchmark.benchmark_name == "flow_over_mountain")
	{
		...
		shackDict.benchmark.h_topo = Sphere2DData_Grid(&(levelSingleton.sphere2DDataConfig));

		// initialize the topography
		levelSingleton.benchmarks.master->setup_topography();
	}*/

	// instantiate the Sphere2DDataCtxSDC object
	int nnodes[1];
