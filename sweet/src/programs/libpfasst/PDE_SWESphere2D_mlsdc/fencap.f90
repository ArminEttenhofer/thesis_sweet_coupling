module encap_module
   ...
   type, extends(pf_factory_t) :: sweet_data_factory_t
      type(c_ptr) :: ctx = c_null_ptr ! c pointer to Cart2DDataCtx/Sphere2DDataCtx
   contains
   ...
   type, extends(pf_encap_t) :: sweet_data_encap_t
      type(c_ptr) :: c_sweet_data_ptr = c_null_ptr ! c pointer to Cart2DData/Sphere2DData
...
contains
   ...
   ! sweet_data (Cart2DData/Sphere2DData) operators
   ...
   subroutine sweet_data_pack(this, z, flags)
      ...
      ! get the data from the sweet object (Cart2DData or Sphere2DData)
   ...
   subroutine sweet_data_unpack(this, z, flags)
      ...
      ! copy the data array into the sweet object (Cart2DData or Sphere2DData)
