...
extern "C"
{
				 ...
				 double i_t) 
  {
	...
	phi_pert_Y_coarse  = phi_pert_Y_fine.spectral_returnWithDifferentModes(i_ctx->get_sphere2d_data_config(i_level_coarse));
	vrt_Y_coarse = vrt_Y_fine.spectral_returnWithDifferentModes(i_ctx->get_sphere2d_data_config(i_level_coarse));
	div_Y_coarse  = div_Y_fine.spectral_returnWithDifferentModes(i_ctx->get_sphere2d_data_config(i_level_coarse));
				...
				double i_t) 
  {
	...
	phi_pert_Y_fine  = phi_pert_Y_coarse.spectral_returnWithDifferentModes(i_ctx->get_sphere2d_data_config(i_level_fine));
	vrt_Y_fine = vrt_Y_coarse.spectral_returnWithDifferentModes(i_ctx->get_sphere2d_data_config(i_level_fine));
	div_Y_fine  = div_Y_coarse.spectral_returnWithDifferentModes(i_ctx->get_sphere2d_data_config(i_level_fine));
