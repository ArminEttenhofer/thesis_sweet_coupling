...
{
	sweet::Data::Sphere2D::Config *Y_config = i_ctx->get_sphere2d_data_config(i_level);
	...
	*o_size = 2*(phi_pert.sphere2DDataConfig->spectral_array_data_number_of_elements
			+ vrt.sphere2DDataConfig->spectral_array_data_number_of_elements
			+ div.sphere2DDataConfig->spectral_array_data_number_of_elements);
}
...
//	const double vrt_max = vrt.toGrid().grid_reduce_max_abs();
//	const double div_max  = div.toGrid().grid_reduce_max_abs();
...
)
{
	...
	const int n_elems = 2*(phi_pert.sphere2DDataConfig->spectral_array_data_number_of_elements
			+  vrt.sphere2DDataConfig->spectral_array_data_number_of_elements
			+   div.sphere2DDataConfig->spectral_array_data_number_of_elements);
