...
#ifndef INCLUDE_SWEET_XBRAID_SHACK_HPP
#define INCLUDE_SWEET_XBRAID_SHACK_HPP
...
public:
					...
					)
	{
		...
		if (i_param_name == "timestepping_method")
			all_param = std::stringstream(xbraid_timestepping_method);
		else if (i_param_name == "timestepping_order")
			all_param = std::stringstream(xbraid_timestepping_order);
		else if (i_param_name == "timestepping_order2")
			all_param = std::stringstream(xbraid_timestepping_order2);
		else if (i_param_name == "viscosity_order")
			all_param = std::stringstream(xbraid_viscosity_order);
		else if (i_param_name == "viscosity_coefficient")
			all_param = std::stringstream(xbraid_viscosity_coefficient);
		else
		...
		if ( ! (out.size() == 1 || out.size() == 2 || out.size() == xbraid_max_levels ) )
