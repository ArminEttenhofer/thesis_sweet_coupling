#ifndef INCLUDE_SWEET_XBRAID_XBRAID_SIMULATIONVARIABLES_HPP
#define INCLUDE_SWEET_XBRAID_XBRAID_SIMULATIONVARIABLES_HPP
...
struct XBraid_SimulationVariables	:
	public sweet::Shacks::ShackInterface
{
