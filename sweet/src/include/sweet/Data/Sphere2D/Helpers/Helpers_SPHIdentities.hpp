...
#ifndef INCLUDE_SWEET_DATA_SPHERE2D_HELPERS_HELPERS_SPHIDENTITIES_HPP
#define INCLUDE_SWEET_DATA_SPHERE2D_HELPERS_HELPERS_SPHIDENTITIES_HPP
...
//			n = -n-1;
	...
	static double R_real(double k, double m)
	{
		...
		SWEET_ASSERT(std::abs(m) <= n);
		SWEET_ASSERT(n*n-m*m >= 0);
		SWEET_ASSERT(n >= 0);
