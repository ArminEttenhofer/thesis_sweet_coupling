...
#ifndef INCLUDE_SWEET_LIBMATH_DQSTUFF_HPP
#define INCLUDE_SWEET_LIBMATH_DQSTUFF_HPP
...
#else
		SWEETErrorFatal("Don't use this function! It generates wrong results in the last digits!");
