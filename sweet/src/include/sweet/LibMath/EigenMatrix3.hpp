...
#ifndef INCLUDE_SWEET_LIBMATH_EIGENMATRIX3_HPP
#define INCLUDE_SWEET_LIBMATH_EIGENMATRIX3_HPP
...
public:
	...
	inline EigenMatrix3()
	{
		SWEETErrorFatal("DO NOT USE EigenMatrix3.hpp : CONFLICTS IN TYPES IN FINAL FORMULA ");
		loadIdentity();
	}
