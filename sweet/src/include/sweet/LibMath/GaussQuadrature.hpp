...
#ifndef INCLUDE_SWEET_LIBMATH_GAUSSQUADRATURE_HPP
#define INCLUDE_SWEET_LIBMATH_GAUSSQUADRATURE_HPP
...
public:
	...
	)
	{
		...
		SWEETErrorFatal("No convergence reached for integrate5_intervals_adaptive");
		return -1;
	}
