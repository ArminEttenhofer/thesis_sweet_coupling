...
#ifndef INCLUDE_SWEET_GUI_VISSWEETHUD_HPP
#define INCLUDE_SWEET_GUI_VISSWEETHUD_HPP
...
public:
	libgl::GlHudConfig cGlHudConfigMainLeft;
	libgl::GlHudConfig cGlHudConfigMainRight;
	libgl::GlHudConfig cGlHudConfigVisualization;
	libgl::GlHudConfig cGlHudConfigInfo;

private:
	libgl::GlWindow windowMain;
	libgl::GlWindow windowLights;
	libgl::GlWindow windowInfo;
...
public:
	...
	libgl::vec3 light0_world_position;

	bool light0_enabled;

	libgl::vec3 light0_ambient_color3;
	libgl::vec3 light0_diffuse_color3;
	libgl::vec3 light0_specular_color3;

	// water material
	libgl::vec3 water_ambient_color3;
	libgl::vec3 water_diffuse_color3;
	libgl::vec3 water_specular_color3;
...
private:
	...
	libgl::GlFreeType *cGlFreeType = nullptr;

	libgl::GlRenderOStream *glRenderOStream = nullptr;
...
public:
	...
	void setup()
	{
		...
		libgl::GlHudConfig::COption o;

		// main window
		//windowMain.setPosition(libgl::ivec2(3, 3));
		//windowMain.setSize(libgl::ivec2(530, 594));
		windowMain.setPosition(libgl::ivec2(3, 400));
		windowMain.setSize(libgl::ivec2(530, 100));
		windowMain.setBackgroundColor(libgl::vec4(74.0/256.0, 96.0/256.0, 150.0/256.0, 0.7));
		...
		cGlHudConfigMainRight.insert(o.setupFloatHI("Timestep size: ", &cSimulationParameters->simulation_parameter_timestepSize, 0.01));
		...
		cGlHudConfigVisualization.insert(o.setupFloat("position X", &light0_world_position[0], 0.1));	light0_world_position = libgl::vec3(0.5, 4.5, 0.5);
		...
		cGlHudConfigVisualization.insert(o.setupFloat("AMBIENT R", &light0_ambient_color3[0], 0.01, 0.0, 1.0));	light0_ambient_color3 = libgl::vec3(1,1,1);
		...
		cGlHudConfigVisualization.insert(o.setupFloat("DIFFUSE R", &light0_diffuse_color3[0], 0.01, 0.0, 1.0));	light0_diffuse_color3 = libgl::vec3(1,1,1);
		...
		cGlHudConfigVisualization.insert(o.setupFloat("SPECULAR R", &light0_specular_color3[0], 0.01, 0.0, 1.0));	light0_specular_color3 = libgl::vec3(1,1,1);
		...
		cGlHudConfigVisualization.insert(o.setupFloat("AMBIENT R", &water_ambient_color3[0], 0.01, 0.0, 111.0));		water_ambient_color3 = libgl::vec3(0.78, 0.88, 1.0);
		...
		cGlHudConfigVisualization.insert(o.setupFloat("DIFFUSE R", &water_diffuse_color3[0], 0.01, 0.0, 111.0));		water_diffuse_color3 = libgl::vec3(0.0f);
		...
		cGlHudConfigVisualization.insert(o.setupFloat("SPECULAR R", &water_specular_color3[0], 0.01, 0.0, 111.0));	water_specular_color3 = libgl::vec3(6.5,6.3,6);
		...
		windowLights.setPosition(libgl::ivec2(536, 3));
		windowLights.setBackgroundColor(libgl::vec4(128.0/256.0, 128.0/256.0, 128.0/256.0, 0.7));
		windowLights.setSize(libgl::ivec2(270, 594));
#endif
		...
		windowInfo.setPosition(libgl::ivec2(10, 10));
		windowInfo.setBackgroundColor(libgl::vec4(256.0/256.0, 256.0/256.0, 128.0/256.0, 0.7));
		windowInfo.setSize(libgl::ivec2(360, 320));
#endif
	}
	...
	void assembleGui()
	{
		...
		cGlFreeType = new libgl::GlFreeType();
		...
		glRenderOStream = new libgl::GlRenderOStream(*cGlFreeType);
...
//		cGlHudConfigVisualization.set_callback(value_ptr, callback_handler, user_ptr);
	...
	bool mouse_button_down(int button)
	{
		if (hud_visible)
		{
			if (windowInfo.inWindow(mouse_x, mouse_y))
			{
				...
				{
					if (button == libgl::RenderWindow::MOUSE_BUTTON_LEFT)
	...
	void mouse_motion(int x, int y)
	{
		...
		if (info_drag_n_drop_active)
			windowInfo.setPosition(windowInfo.pos + libgl::ivec2(dx, dy));

		if (main_drag_n_drop_active)
			windowMain.setPosition(windowMain.pos + libgl::ivec2(dx, dy));

		if (lights_drag_n_drop_active)
			windowLights.setPosition(windowLights.pos + libgl::ivec2(dx, dy));
