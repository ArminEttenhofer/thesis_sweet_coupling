...
#ifndef INCLUDE_SWEET__DEPRECATED_DEPRECATED_TIMESTEPPINGEXPLICITRKSPHERE2DDATA_HPP
#define INCLUDE_SWEET__DEPRECATED_DEPRECATED_TIMESTEPPINGEXPLICITRKSPHERE2DDATA_HPP
...
class DEPRECATED_TimesteppingExplicitRKSphere2DData
{
	// Runge-Kutta data storages
	std::vector<sweet::Data::Sphere2D::DataSpectral*> RK_prog0_stage_t;
	std::vector<sweet::Data::Sphere2D::DataSpectral*> RK_prog1_stage_t;
	std::vector<sweet::Data::Sphere2D::DataSpectral*> RK_prog2_stage_t;

	std::vector<sweet::Data::Sphere2D::DataGrid*> RK_vel_u;
	std::vector<sweet::Data::Sphere2D::DataGrid*> RK_vel_v;

	int runge_kutta_order;

public:
	DEPRECATED_TimesteppingExplicitRKSphere2DData()	:
		runge_kutta_order(-1)
	{
	}
	...
	)
	{
		...
		if (N <= 0 || N > 4)
			SWEETErrorFatal("Invalid order for RK time stepping");
		...
		for (int i = 0; i < N; i++)
		{
			RK_prog0_stage_t[i] = new sweet::Data::Sphere2D::DataSpectral(i_sphere2DDataConfig);
			RK_prog1_stage_t[i] = new sweet::Data::Sphere2D::DataSpectral(i_sphere2DDataConfig);
			RK_prog2_stage_t[i] = new sweet::Data::Sphere2D::DataSpectral(i_sphere2DDataConfig);
		}
	}
	...
	)
	{
		...
		{
			RK_prog0_stage_t[i] = new sweet::Data::Sphere2D::DataSpectral(i_sphere2DDataConfig);
			RK_vel_u[i] = new sweet::Data::Sphere2D::DataGrid(i_sphere2DDataConfig);
			RK_vel_v[i] = new sweet::Data::Sphere2D::DataGrid(i_sphere2DDataConfig);
		}
	}
	...
	void runTimestep(
			...
			void (BaseClass::*i_compute_euler_timestep_update)(
					const sweet::Data::Sphere2D::DataSpectral &i_P,	//!< prognostic variables
					const sweet::Data::Sphere2D::DataSpectral &i_u,	//!< prognostic variables
					const sweet::Data::Sphere2D::DataSpectral &i_v,	//!< prognostic variables

					sweet::Data::Sphere2D::DataSpectral &o_P_t,		//!< time updates
			...
			sweet::Data::Sphere2D::DataSpectral &io_h,
	...
	{
		resetAndSetup(io_h.sphere2DDataConfig, i_runge_kutta_order);
	...
	{
		resetAndSetup_na(io_h.sphere2DDataConfig, i_runge_kutta_order);
	...
	)
	{
		...
		{
			SWEETErrorFatal("This order of the Runge-Kutta time stepping is not supported!");
		}
	}
	...
	void runTimestep(
			BaseClass *i_baseClass,
			void (BaseClass::*i_compute_euler_timestep_update)(
					const sweet::Data::Sphere2D::DataSpectral &i_h,		//!< prognostic variables
