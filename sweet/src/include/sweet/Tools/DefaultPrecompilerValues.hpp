...
#ifndef INCLUDE_SWEET_TOOLS_DEFAULTPRECOMPILERVALUES_HPP
#define INCLUDE_SWEET_TOOLS_DEFAULTPRECOMPILERVALUES_HPP
 ...
 */
	...
	#error "SWEET_USE_SPHERE2D_SPECTRAL_SPACE not set"
	#define SWEET_USE_SPHERE2D_SPECTRAL_SPACE 1
#endif

#ifndef SWEET_USE_CART2D_SPECTRAL_SPACE
	#error "SWEET_USE_CART2D_SPECTRAL_SPACE not set"
	#define SWEET_USE_CART2D_SPECTRAL_SPACE 1
#endif
 ...
 */
	...
	#define SWEET_USE_CART2D_SPECTRAL_SPACE	1
		...
		#error "Dealiasing only available with cart2d-spectral-space enabled"
	#endif
#endif
 ...
 */
#ifndef SWEET_USE_CART2D_SPECTRAL_DEALIASING
	#define SWEET_USE_CART2D_SPECTRAL_DEALIASING 1
#endif
