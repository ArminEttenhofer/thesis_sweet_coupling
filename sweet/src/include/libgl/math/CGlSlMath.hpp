...
#ifndef INCLUDE_SWEET_LIBMATH_CGLSLMATH_HPP
#define INCLUDE_SWEET_LIBMATH_CGLSLMATH_HPP

#include <cmath>
#include <libgl/math/CMatrix.hpp>
#include <libgl/math/CVector.hpp>
...
{
	return vec3(std::abs(v.data[0]), std::abs(v.data[1]), std::abs(v.data[2]));
}
