...
#ifndef INCLUDE_SWEET_LIBMATH_CVECTOR4_HPP
#define INCLUDE_SWEET_LIBMATH_CVECTOR4_HPP

#ifndef INCLUDE_SWEET_LIBMATH_CVECTOR_HPP
...
public:
	...
	inline T length()
	{
		return std::sqrt<T>(data[0]*data[0] + data[1]*data[1] + data[2]*data[2] + data[3]*data[3]);
	}
