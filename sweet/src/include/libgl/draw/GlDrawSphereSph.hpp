...
#ifndef INCLUDE_SWEET_LIBGL_DRAW_GLDRAWSPHERE2DSPH_HPP
#define INCLUDE_SWEET_LIBGL_DRAW_GLDRAWSPHERE2DSPH_HPP
...
#include <libgl/math/CGlSlMath.hpp>
	...
	#error "SWEET_USE_SPHERE2D_SPECTRAL_SPACE not activated"
#endif
...
public:
	 ...
	 */
	void initBuffers(
			const sweet::Data::Sphere2D::Config *i_sphereDataConfig
	)
	{
		int hsegments = i_sphereDataConfig->grid_num_lon;
		int vsegments = i_sphereDataConfig->grid_num_lat;
