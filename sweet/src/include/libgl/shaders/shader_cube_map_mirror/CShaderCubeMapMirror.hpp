#ifndef INCLUDE_SWEET_LIBGL_SHADERS_SHADER_CUBE_MAP_MIRROR_CSHADERCUBEMAPMIRROR_HPP
#define INCLUDE_SWEET_LIBGL_SHADERS_SHADER_CUBE_MAP_MIRROR_CSHADERCUBEMAPMIRROR_HPP
