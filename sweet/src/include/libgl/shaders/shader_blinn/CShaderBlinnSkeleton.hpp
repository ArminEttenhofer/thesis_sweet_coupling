 ...
 */
#ifndef INCLUDE_SWEET_LIBGL_SHADERS_SHADER_BLINN_CSHADERBLINNSKELETON_HPP
#define INCLUDE_SWEET_LIBGL_SHADERS_SHADER_BLINN_CSHADERBLINNSKELETON_HPP
...
public:
	...
	void setupUniformsMatrices(	const mat4 &pvm_matrix,
								const mat4 &view_model_matrix,
								const mat3 &view_model_normal_matrix3
	)
	{
