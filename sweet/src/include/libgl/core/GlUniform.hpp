...
#ifndef INCLUDE_SWEET_LIBGL_CORE_GLUNIFORM_HPP
#define INCLUDE_SWEET_LIBGL_CORE_GLUNIFORM_HPP
...
public:
	...
	{
		glUniformMatrix4fv(location, 1, GL_TRUE, value_ptr(matrix));
		CGlErrorCheck();
	}
	 ...
	 * set mat3 uniform
	 */
	inline void set(const mat3 &matrix)
	{
		glUniformMatrix3fv(location, 1, GL_TRUE, value_ptr(matrix));
		CGlErrorCheck();
	}
	 ...
	 * set vec2 uniform
	 */
	inline void set(const vec2 &vector)
	{
	 ...
	 * set vec3 uniform
	 */
	inline void set(const vec3 &vector)
	{
	 ...
	 * set vec4 uniform
	 */
	inline void set(const vec4 &vector)
	{
	 ...
	 * set ivec2 uniform
	 */
	inline void set(const ivec2 &vector)
	{
		glUniform2iv(location, 1, value_ptr(vector));
		CGlErrorCheck();
	}
	 ...
	 * set ivec3 uniform
	 */
	inline void set(const ivec3 &vector)
	{
		glUniform3iv(location, 1, value_ptr(vector));
		CGlErrorCheck();
	}
	 ...
	 * set ivec4 uniform
	 */
	inline void set(const ivec4 &vector)
	{
		glUniform4iv(location, 1, value_ptr(vector));
		CGlErrorCheck();
	}
