...
#ifndef INCLUDE_SWEET_LIBGL_ENGINE_CAMERA_CAMERACOMMON_HPP
#define INCLUDE_SWEET_LIBGL_ENGINE_CAMERA_CAMERACOMMON_HPP
...
public:
	...
	{
		projection_matrix = libgl::frustum(left, right, bottom, top, nearval, farval);
	}
