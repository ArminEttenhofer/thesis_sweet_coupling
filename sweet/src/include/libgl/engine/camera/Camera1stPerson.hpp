...
#ifndef INCLUDE_SWEET_LIBGL_ENGINE_CAMERA_CAMERA1STPERSON_HPP
#define INCLUDE_SWEET_LIBGL_ENGINE_CAMERA_CAMERA1STPERSON_HPP

#include <libgl/engine/camera/CameraCommon.hpp>
#include <array>
#include <libgl/math/CGlSlMath.hpp>
#include <libgl/math/CQuaternion.hpp>
...
public:
	...
	inline void computeMatrices()
	{
		...
		CameraCommon<T>::view_matrix = CMatrix4<T>(rotation_quaternion.getRotationMatrix())*translate(-position);
	}
};
