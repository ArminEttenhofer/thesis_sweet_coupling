...
#ifndef INCLUDE_SWEET_LIBGL_ENGINE_MATERIAL_HPP
#define INCLUDE_SWEET_LIBGL_ENGINE_MATERIAL_HPP
...
public:
	...
	vec3 ambient_color3;	//!< ambient color
	vec3 diffuse_color3;	//!< diffuse color
	float specular_exponent;	//!< specular exponent
	vec3 specular_color3;	//!< specular color
