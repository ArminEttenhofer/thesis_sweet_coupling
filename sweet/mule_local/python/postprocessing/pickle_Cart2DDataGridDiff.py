...
class pickle_Cart2DDataGridDiff(InfoError):
    ...
    def __init__(
        ...
        params: list of strings
            ...
            ohter parameters:
                see Cart2DDataGridDiff.py
        """

        InfoError.__init__(self, "pickle_Cart2DDataGridDiff")
        ...
        for key, job in jobs.items():
            ...
            for ref_file in ref_files:
                ...
                if '_spec_' in ref_file:
                    ...
                    pickle_filename = 'cart2d_data_diff_'+ref_file.replace('output_', '').replace(use_ref_file_ending, '')+'.pickle'
