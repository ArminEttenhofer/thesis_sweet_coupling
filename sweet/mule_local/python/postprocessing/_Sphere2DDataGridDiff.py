...
class Sphere2DDataGridDiff:
    ...
    def write_file(
        ...
        pickle_data['WARNING'] = "L1 and L2 don't include scaling factors for different cell spacings around the sphere2d!!!"
...
if __name__ == "__main__":
    if len(sys.argv) <= 2:
        ...
        print("")
        print("    infile A:")
        print("        First input .[sweet/csv] file with spectral or grid space data on the sphere2d")
        print("")
        print("    infile B:")
        print("        Second input .[sweet/csv] file with spectral or grid space data on the sphere2d")
        print("")
        print("    picklefile:")
