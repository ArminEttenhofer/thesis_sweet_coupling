...
class Cart2DDataGridDiff(InfoError):
    ...
    def __init__(
        ...
        InfoError.__init__(self, "Cart2DDataGridDiff")
        self.params = params
    ...
    def compute_diff(
        ...
        file_b = Cart2DDataGrid(filename_b)
        file_a = Cart2DDataGrid(filename_a)
        ...
        if size_ref_j == size_cmp_j and size_ref_i == size_cmp_i:# and False:
            ...
            # print("Interpolation")
            # A-grid REFERENCE (file1) - sweet outputs only A grids grid space
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        print("")
        print("    infile A:")
        print("        First input .csv file with grid space data on the cart2d")
        print("")
        print("    infile B:")
        print("        Second input .csv file with grid space data on the cart2d")
        print("")
        print("    parameters:")
        print("        'interpolate':")
