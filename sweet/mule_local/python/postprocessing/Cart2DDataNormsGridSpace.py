...
from mule.postprocessing.Cart2DData import *


class Cart2DDataNormsGridSpace:
    ...
    def compute_diff(
        ...
        file_a = Cart2DData(filename_a, setup_grid=False)
        file_b = Cart2DData(filename_b, setup_grid=False)
