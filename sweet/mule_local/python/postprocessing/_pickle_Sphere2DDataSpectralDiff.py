...
from mule.postprocessing.Sphere2DDataSpectralDiff import *
from mule.parhelper import *


class pickle_Sphere2DDataSpectralDiff:
    ...
    def _setup(
        ...
        def proc_job(key, job):
            ...
            for cmp_file in cmp_files:
                ...
                pickle_filename = 'sphere2d_data_diff_'+cmp_file.replace('output_', '').replace(use_cmp_file_ending, '')+'.pickle'
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        p = pickle_Sphere2DDataSpectralDiff(sys.argv[1:])
    else:
        p = pickle_Sphere2DDataSpectralDiff()
