...
class Cart2DData_KineticEnergy(InfoError):
    ...
    def __init__(
        ...
        InfoError.__init__(self, "Cart2DData_KineticEnergy")
        self.params = params
    ...
    def compute_ke(
        ...
        udata_ = Cart2DDataGrid(filename_u)
        udata = udata_.data

        vdata_ = Cart2DDataGrid(filename_v)
        vdata = vdata_.data
