...
from mule.postprocessing.Cart2DData_Spectrum import *



class pickle_Cart2DData_Spectrum(InfoError):
    ...
    def __init__(
        ...
        params: list of strings
            ...
            other parameters:
                see Cart2DData_Spectrum.py
        """

        InfoError.__init__(self, "pickle_Cart2DData_Spectrum")
...
if __name__ == '__main__':
    ...
    #p = pickle_Cart2DData_Spectrum(params=['only_last_file'])
    p = pickle_Cart2DData_Spectrum()
