...
from mule.postprocessing.Sphere2DDataGridDiff import *
from mule.postprocessing.Cart2DDataGridDiff import *
from mule.parhelper import *
from mule.postprocessing.Sphere2DReadBinFile import read_bin_file
...
class PInT_Errors:
    ...
    def read_pint_errors_job(self, job):
        ...
        for f in list_files:
            ...
            if self.error_type == "grid" and "_spec_" in f:
                continue
    ...
    def compute_pint_errors_job(self, job):
        ...
        for f in list_files:
            ...
            ## compute errors
            if self.err_type == "grid":
                if self.file_type == "csv":
                    if self.geometry == "cart2d":
                        raise Exception("Not yet implemented")
                    else:
                        e = Sphere2DDataGridDiff(
    ...
    def get_pint_errors(self):
        ...
        if self.precomputed_errors:
            for job in self.jobs.keys():
                ...
                ##pickle_filename = 'sphere2d_data_diff_'+ref_file.replace('output_', '').replace(use_ref_file_ending, '')+'.pickle'
