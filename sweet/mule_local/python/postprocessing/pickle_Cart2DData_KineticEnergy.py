...
from mule.postprocessing.Cart2DData_KineticEnergy import *



class pickle_Cart2DData_KineticEnergy(InfoError):
    """
    ...
    def __init__(
        ...
        params: list of strings
            ...
            ohter parameters:
                see Cart2DData_KineticEnergy.py
        """

        InfoError.__init__(self, "pickle_Cart2DData_KineticEnergy")
    ...
    def _setup(
        ...
        for key, job in jobs.items():
            ...
            for u_vel_file in u_vel_files:
                ...
                if 'only_last_file' in params:
                    pickle_filename = 'cart2d_data_kinetic_energy.pickle'
                    ...
                    pickle_filename = 'cart2d_data_kinetic_energy'+pickle_file_ending+'.pickle'
...
if __name__ == '__main__':
    ...
    #p = pickle_Cart2DData_KineticEnergy(params=['only_last_file'])
    p = pickle_Cart2DData_KineticEnergy()
