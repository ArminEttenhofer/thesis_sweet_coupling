...
from mule.postprocessing.Sphere2DDataSpectral import *


class Sphere2DDataSpectralDiff:
    ...
    def compute_diff(
        ...
        file_a = Sphere2DDataSpectral(filename_a)
        file_b = Sphere2DDataSpectral(filename_b)
...
if __name__ == "__main__":
    if len(sys.argv) <= 2:
        ...
        print("")
        print("    infile A:")
        print("        First input .csv file with grid space data on the sphere2d")
        print("")
        print("    infile B:")
        print("        Second input .csv file with grid space data on the sphere2d")
        print("")
        print("    picklefile:")
