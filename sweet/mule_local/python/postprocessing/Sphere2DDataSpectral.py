...
class Sphere2DDataSpectral:

    def __init__(self, filename = None, setup_grid=True):

        self.data_grid = None
        self.data_spectral = None

        if filename != None:
            self.read_file(filename, setup_grid=setup_grid)


    def read_file(self, filename, setup_grid=True):
        input_file = filename
