...
latex_pretty_names = {
	...
	'sphere2d_data_diff_prog_phi_pert.res_norm_l1'	: '$L_1$ norm on geopotential (res. normalized)',
	'sphere2d_data_diff_prog_phi_pert.res_norm_l2'	: '$L_2$ norm on geopotential (res. normalized)',
	'sphere2d_data_diff_prog_phi_pert.res_norm_linf'	: '$L_{\infty}$ norm on geopotential',

	'sphere2d_data_diff_prog_vrt.res_norm_l1'	: '$L_1$ norm vorticity (res. normalized)',
	'sphere2d_data_diff_prog_vrt.res_norm_l2'	: '$L_2$ norm vorticity (res. normalized)',
	'sphere2d_data_diff_prog_vrt.res_norm_linf'	: '$L_{\infty}$ norm vorticity',

	'sphere2d_data_diff_prog_div.res_norm_l1'	: '$L_1$ norm divergence (res. normalized)',
	'sphere2d_data_diff_prog_div.res_norm_l2'	: '$L_2$ norm divergence (res. normalized)',
	'sphere2d_data_diff_prog_div.res_norm_linf'	: '$L_{\infty}$ norm divergence',
}
