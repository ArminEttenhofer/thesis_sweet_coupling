...
#
p.runtime.space_res_spectral = 256
p.runtime.space_res_grid = -1
...
#
p.compile.program = 'programs/PDE_SWESphere2D'

p.compile.cart2d_spectral_space = 'disable'
p.compile.cart2d_spectral_dealiasing = 'disable'
p.compile.sphere2d_spectral_space = 'enable'
p.compile.sphere2d_spectral_dealiasing = 'enable'
...
#
#p.runtime.rexi_sphere2d_preallocation = 1
