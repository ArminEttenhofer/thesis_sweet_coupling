...
def add_source_files(env, jg):
    ...
    #
    file_and_directory_list = env["additional_files_or_dirs"]+co["compile_files_and_dirs"]
    #file_and_directory_list = co["compile_files_and_dirs"]+env["additional_files_or_dirs"]
